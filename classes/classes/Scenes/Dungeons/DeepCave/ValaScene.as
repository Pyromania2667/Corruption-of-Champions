...
public class ValaScene extends BaseContent implements SaveableState
	{
		...
		public function chooseValaInBar():void {
			...
			addButton(5,"Leave",SceneLib.telAdre.barTelAdre);
		}
		...
		public function Scepter2():void {
			...
			if (player.isFemaleOrHerm && (player.humanScore() >= (player.humanMaxScore() - player.internalChimeraScore())) || player.elfScore() >= 11)
			{
				outputText("Vala spots you from a distance and flies to you right away.\n\n" +
						...
						"\"<i>You're already so eager? Well, this may get a little complicated... Follow me.</i>\"\n\n" +
						"Vala escorts you to the woods where you spot an unusual amount of fairies watching you. You both enter what looks to be a grove. You can see a small bubble of energy slowly flying up from the ground and deduce the place is highly magical. Vala turns to face you looking somewhat embarrassed.\n\n" +
						"\"<i>[name], when we first met, I wanted to thank you for saving me from those imps. While I enjoy our intimacy together... I never could really feel like it was enough to let go of my debt to you. Today, I’m actually telling you something no human has ever been told. We, the fairies would like you to become our champion.</i>\"\n\n" +
						"You pause, unsure how you feel about the idea.\n\n" +
						"\"<i>You don’t understand. What the fairies agreed to is that YOU should be the next queen.</i>\”\n\n" +
						...
						"As you glance at the tiny fairies around, you note you’re far too big to become a fairy to begin with. \n\nVala laughs before she speaks up.\n\n" +
						"\"<i>Out of all the fairies, the queen is the only one to naturally reach your size. Fact is, we fairies need a proper champion like you to protect us since our diminutive size won’t allow us to protect ourselves with ease.</i>\"\n\n" +
						"Vala pauses as she eyes you once more." +
						"\"<i>You are a true champion, [name]. The fairies need someone like you who is still pure of mind and body to protect them. So, will you accept?</i>\"\n\n" +
		...
		public function Accept():void {
			...
			outputText("While this is a great honor, maybe too much for a human you still nod in agreement. Vala hugs you right away.\n\n" +
					...
					"You dream of a beautiful world from before the age of the demons as you walk in a floral palace filled with echoes of laughter and cheers. Small fairies fly from one side to another, singing while carrying foods, flowers, and various items. At the back of the room is a figure of greater size. \n\nSitting on a crystalline throne is a woman who wields no crown yet has the presence of royalty. While bigger in size than her sisters who fly in this otherworldly palace she is nonetheless a fairy and only one word comes to your mind to describe her… queen. This fairy sports a pair of colorful translucent butterfly wings which stretch six feet wide on a mature, almost perfect body not unlike that of an elf. \n\nHer regal visage turns toward you and looks straight in your eyes as if peering at the depth of your soul. It is only as you realise this royal figure was a beautified version of yourself all along that you slowly open your eyes, waking up with a loud yawn. The flower feels bigger than what you remembered it to be and so you slowly part away the petals so to let the light of the sun filter in. \n\nTo your surprise, it's not the flower that got smaller but your body which got slightly bigger. While your overall shape did not change that much your body took on a more fragile and graceful version of itself, almost a mimicry of that of the elves. Your unblemished skin and refined limbs wouldn't look out of place on a nymph, not to mention your elf like pointed ears. \n\nHowever what really sets you apart from a human is your shiny, almost translucent hair, in which many beads of morning dew shine like beautiful gems, and your large, colorful butterfly wings easily twice as wide as your stretched arms. You flap them a few times with childlike curiosity and only stop short of taking flight. While admiring your new body you can't help but wish the flower was just a little bigger. To your surprise, you begin to shrink in size. \n\nThe world suddenly becomes bigger around you, including dog sized bugs you swiftly return to normal realizing that you can now shrink and grow back to human size at will. Heck, this is only a fragment of your new powers as you begin exploring the many fae magical abilities you acquired. After a few minutes, satisfied with your inspection, you finally take the time to gaze beyond the flower back to your waiting subjects. \n\nThese fairies need a champion and a leader to fight for and rule them, you won’t let the fairies or Vala down. Lethice shall be defeated and the fairies protected! A few fairies come over to you carrying a human sized dress that could actually fit you just right. Its light but... perhaps a little skimpy? Well at least it won't hinder your flight. Still you are amazed they got it so quickly. To humor them you put the dress on and discover to your delight that it is the dress from the dream. Vala cheers for you right away pulling all the other fairies in.\n\n" +
		...
		public function faerieOrgyFuckMaleContinue():void {
			...
			//[Balls-
			if(player.balls > 0) outputText("Vala's tongue caresses your [balls], slurping hungrily, eager to get every drop out of your overburdened sac.  ");
